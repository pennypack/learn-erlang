...
<ErlangKoans koans={[
  ...
  {
    id: "variables1",
    question: "Assign the number 42 to variable X, then retrieve X",
    answer: "X = 42.",
  ...
  },
  {
    ...
    answer: "A + B.",
    hint: "Variables can be used in expressions",
    explanation: "Variables hold values that can be used in calculations"
  },
  {
    id: "atoms1",
